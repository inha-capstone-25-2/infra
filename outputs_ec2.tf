...
output "nlp_ec2_id" {
  value       = module.nlp_ec2.id
  description = "ID of NLP EC2"
}

output "nlp_private_ip" {
  value       = module.nlp_ec2.private_ip
...
output "monitoring_private_ip" {
  ...
  description = "Private IP of Monitoring EC2"
}